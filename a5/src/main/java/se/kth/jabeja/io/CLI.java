...
public class CLI {
    ...
    @Option(name = "-minTemp", usage = "Minimum temperature in exponential simulated annealing.")
    private float MIN_TEMP = 0.001f;
    ...
    @Option(name = "-tempExpDecay", usage = "Exponential simulated annealing decay")
